...
from models.DSFD_ours import build_net
...
if __name__ == '__main__':
    ...
    exp_name = 'DSDF-Ours-resnet-pretrained'
    ...
    for epoch in range(num_epochs):
        ...
        for i, (images, fft_images, targets) in enumerate(tbar):
            ...
            tbar.set_description(f'[Train] Epoch {epoch+1}/{num_epochs}, Iteration {train_iter}, Loss: {loss.item():.4f}, L1 Loss: {l1_loss.item():.4f}')
