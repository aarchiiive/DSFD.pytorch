...
class MultiBoxLoss(nn.Module):
    ...
    def __init__(
        ...
        self.num_classes = num_classes # cfg.NUM_CLASSES
        self.negpos_ratio = negpos_ratio # cfg.NEG_POS_RATIOS
        self.variance = variance # cfg.VARIANCE

        self.threshold = threshold # cfg.FACE.OVERLAP_THRESH
